...
For best results in vSphere (screenshots here are from vCenter), it's best to power down the virtual machine first.  

Then, we add a host USB device to the virtual machine.  
![](1_newdevice.png)  
