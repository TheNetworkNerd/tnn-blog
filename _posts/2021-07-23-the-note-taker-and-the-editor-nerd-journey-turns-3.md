...
permalink: /2021/07/22/the-note-taker-and-the-editor-nerd-journey-turns-3/
categories: 
  - "Career"
tags: 
  - "Audacity"
...
It's been 3 years since [Nerd Journey](https://nerd-journey.com/)'s official launch, and the time has flown by.  I wrote reflection posts at [launch]({% link _posts/2018-07-17-two-nerds-on-a-journey.md %}), at the [one year mark]({% link _posts/2019-07-01-the-journey-continues-one-year-later.md %}), [when we hit 100 episodes]({% link _posts/2020-12-16-over-100-episodes-later-and-the-journey-continues.md %})...but this one, written at the 3 year mark, somehow seems different.  Despite learning from many more people we interviewed and having [our first repeat guest](https://nerd-journey.com/dealing-with-personal-loss-and-grief-with-mike-burkhart/), there was more I needed to learn.

In [Episode 113](https://nerd-journey.com/a-series-of-humbling-experiences-with-brad-christian-1-2/) I made an announcement that John needed to take a short break from being on the show.  In the recently released [Episode 128](https://nerd-journey.com/the-process-of-stepping-away-and-back-again/), we share the story of how this unfolded.  I'd like to share a little more of the experience and how it impacted me.
...
- Who are the characters that will go on the adventure?
    - When you're flying solo, it's one thing to carry a few minutes of air time on your own.  But I didn't want to have to do an entire solo episode if I could avoid it.   I was, after all, in every conversation at work or outside of it, every read of a LinkedIn post, [listening for stories]({% link _posts/2020-12-16-over-100-episodes-later-and-the-journey-continues.md %}).  If I could help someone else tell their story to help the community, that seemed better than the Nick Korte solo act for a full episode.
...
Feel free to [contact us](https://twitter.com/NerdJourney) if you have an idea for a show or need help on the journey.
