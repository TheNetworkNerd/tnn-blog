...
How do you know when a body of work is complete? When should a long-running project come to an end? After asking various forms of this question so many times to guests on the [Nerd Journey Podcast](https://nerd-journey.com/), this is the story of how I answered the question for myself.

### A Friendship that Transcends Podcasting

It’s been just over 8 years since John White sent me the message that said, “we should start a podcast.” I had no idea what saying yes to that suggestion would mean at the time or what I could contribute to a podcast. Creating and running Nerd Journey is something we did to help others with their careers in much the same way we had received help with our own. It taught us to lead discussions, curate career stories, sell the value of being a guest on our show, edit audio content, and ship our work. We started the show together, [launched it in July 2018]({% link _posts/2018-07-17-two-nerds-on-a-journey.md %}), and just recently, we recorded the final episode. Independent of the show, John remains one of my best friends on the planet.
...
My [healthy obsession]({% link _posts/2025-01-26-a-healthy-obsession-lessons-learned-from-300-episodes-of-the-nerd-journey-podcast.md %}) was easy to maintain through changes like losing parents and grandparents, changes at work through an acquisition, and a kid who keeps growing up. It was a safe haven from the noise, stress, and a place where my mind could rest.

### A Brittle System Revealed

Producing a weekly podcast takes time. Guest recruitment and conducting interviews is part of the equation, but then there’s editing, show notes, recording intro and outro segments, and all the remaining polish needed for a fully released episode. The production team was just the two of us, and [starting around episode 113]({% link _posts/2021-07-23-the-note-taker-and-the-editor-nerd-journey-turns-3.md %}), it was mostly me doing the production. But I was happy to do it because I wanted to keep the show going.
...
During this same time, I needed advice. This is when I turned to our catalog of episodes. Seth Godin said in [The Practice](https://www.amazon.com/Practice-Shipping-Creative-Work/dp/0593328973) that the work you’ve done in the past is a gift to your future self. I realized just how true that is.

I immediately sought to listen back to our discussion with Amy Lewis about the decision to end [The Geek Whisperers](https://geek-whisperers.com/2017/10/the-final-whispers-episode-140/) with intention. Maybe reminding myself why they ended the show would provide insight on what to do. [Episode 302](https://nerd-journey.com/ending-with-intention-once-a-geek-whisperer-with-amy-lewis-2-2/) talked about their decision to end the show while it was still good so that it didn’t just fade away. They wanted to build a body of work they could be proud of, and they walked away proud. Amy also talked about how we have to put something down to pick something else up and highlighted the courage required to make that decision. Maybe it was time to be brave.

I also listened back to [Episode 127 - Countdown to Burnout with Tom Hollingsworth (3/3)](https://nerd-journey.com/countdown-to-burnout-with-tom-hollingsworth-3-3/). There’s a part where Tom talks about making sure we don’t ignore it when people tell us we need to slow down / that we are redlining from a health perspective. Multiple people were saying it to me, and I needed to take action.

I still had the final episode of the Datanauts podcast with [Ethan Banks](https://nerd-journey.com/everything-has-a-lifecycle-with-ethan-banks-1-2/) and [Chris Wahl](https://nerd-journey.com/find-your-gratitude-find-your-joy-with-chris-wahl-2-2/) downloaded on my phone. In it they talked about their own reasons for bringing their show to an end. Creating a farewell episode was a courtesy and a thank you to all the listeners who had invested time in them. And it gave me some ideas we could use to craft our own farewell if that was the direction we chose.
...
Listen to the final episode of the Nerd Journey Podcast here - [An Intentional Ending: Completing the Journey for This Body of Work](https://nerd-journey.com/an-intentional-ending-completing-the-journey-for-this-body-of-work).

- IMPORTANT NOTE: The podcast content will remain online and reachable. You can listen to the full catalog wherever you get your podcasts or on [our website](https://nerd-journey.com/).
...
Special shout out to former guest [Kelly Schroeder](https://nerd-journey.com/tag/kelly-schroeder/) for reading and providing feedback on this post before it went live!
